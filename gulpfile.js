...
function watchTask()
{
	...
	watch([files.phpPath, files.scssPath, files.coursesPath, files.projectsPath, files.worksPath], 
        parallel(php, coursesjs,  projectsjs, worksjs, scss)
    ).on('change', browserSync.reload);
}

// Gulp basic task
exports.default = series(
    parallel(php, coursesjs, projectsjs, worksjs, scss, watchTask),
);